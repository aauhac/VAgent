...
def test_versions_bumped():
    ...
    assert cfg.FUNCTION_ENGINE_VERSION == "vocal-function-v2.13"
    assert cfg.REPORT_VERSION == "vocal-coach-report-v2.13"
    assert SONG_DETAIL_REPORT_VERSION == "vocal-coach-report-v2.13"
