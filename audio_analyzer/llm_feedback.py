...
def generate_feedback(
    ...
    # LLM이 스키마를 따르지 않은 경우 사전 계산된 vocal_assessment로 폴백
...
def build_user_friendly_report(feedback: dict) -> str:
    ...
    notes = feedback.get("analysis_notes") or []
    if notes:
        lines.append("")
