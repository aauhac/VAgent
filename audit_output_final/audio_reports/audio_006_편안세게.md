...
**Audit status:** `PASS`  
**Audio id:** `10d07cc48c55`

## 기본 정보

- 파일: `C:\VocalAgent\편안세게.m4a`
- SHA: `10d07cc48c5598fbd2497f0391de54c659e0fafdd7133ad7c9678f3c11b93e6f`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
접촉감은 단단한 편이지만, 성구 연결이 일부 구간에서만 안정적으로 이어지는, 발성 안정성이 유지되는 편인, 중역 존재감이 낮은 편인, 밝기가 어두운 편인, 숨 섞임이 적은 편인 발성으로 분석됐어요.
...
4. **brightness** — 밝기가 어두운 편
5. **breathiness** — 숨 섞임이 적은 편
...
| 거칠게 들려요 | CONTACT | 거친 인상이 덜한 쪽으로, 작은~중간 강도에서 짧은 구절을 2~3회 부르세요. 음절 사… | MAINTAIN | PASS |
...
- Focus 종류: BRIGHTNESS, CONTACT, DYNAMICS, MAINTAIN, PRESENCE, REGISTER_CONNECTION, SAFETY, STABILITY, TIMBRE
- Protocol 종류: DYNAMICS, MAINTAIN, PHRASE_ENDURANCE, PRESENCE, REGISTER_CONNECTION, SAFETY, TIMBRE_STYLE, VIBRATO_CONTROL
- Expected shared: 45
- Over-shared: 0
- Wrong collapse: 0
...
|---|---|---|---|
| effort | LOW | LOW | MATCH |
| register_connection | — | PARTIAL | NOT_LABELED |
| breathiness | — | LOW | NOT_LABELED |
| brightness | — | LOW | NOT_LABELED |
| presence | — | LOW | NOT_LABELED |
