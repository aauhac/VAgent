# Audio 007 — 거의동117.m4a

**Audit status:** `PASS`  
**Audio id:** `1387ae324719`

## 기본 정보

- 파일: `C:\VocalAgent\거의동117.m4a`
- SHA: `1387ae32471971bc218ae0757b085555d8d2ba8a936169a0c556883b685c6361`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
성구 연결이 일부 구간에서만 안정적으로 이어지는이지만, 발성 안정성이 유지되는 편인, 중역 존재감이 낮은 편인, 숨 섞임이 적은 편인 발성으로 분석됐어요.
...
| 소리가 답답하게 들려요 | PRESENCE | 답답·어두운 인상이 덜한 쪽으로, 편한 중음에서 짧은 모음을 1~2초 유지하세요. 음량… | PRESENCE | PASS |
...
- Focus 종류: DYNAMICS, EFFORT, PRESENCE, REGISTER_CONNECTION, SAFETY, STABILITY
- Protocol 종류: DYNAMICS, EFFORT, PHRASE_ENDURANCE, PRESENCE, REGISTER_CONNECTION, SAFETY, STABILITY, VIBRATO_CONTROL
- Expected shared: 25
- Over-shared: 0
- Wrong collapse: 0
