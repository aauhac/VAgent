# Audio 008 — Lyrics.mp3

**Audit status:** `REVIEW`  
**Audio id:** `15f8e161f598`

## 기본 정보

- 파일: `C:\VocalAgent\Lyrics.mp3`
- SHA: `15f8e161f5987f8ea83bccbe92a8ac25ac3260cfdb67bbd40483ae76e527e6a9`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
음역이 올라가는 과정에서 성구 연결 변화가 큰이지만, 발성 안정성이 유지되는 편인, 밝기가 어두운 편인, 숨 섞임이 적은 편인 발성으로 분석됐어요.
