# Audio 067 — upload.wav

**Audit status:** `REVIEW`  
**Audio id:** `e8b8aa373520`

## 기본 정보

- 파일: `C:\VocalAgent\runtime\0cd50917f9ed40d1a9e62a9f5904268f\upload.wav`
- SHA: `e8b8aa37352029f955420e5e5a5d98ba9dcf3a52913aa1630f8a89515c0b55dc`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
접촉감은 가벼운 편이지만, 성구 연결이 일부 구간에서만 안정적으로 이어지는, 발성 안정성이 유지되는 편인, 중역 존재감이 낮은 편인, 밝기가 어두운 편인, 숨 섞임이 두드러지는 발성으로 분석됐어요.
...
2. **breathiness** — 숨 섞임이 두드러지는 편
3. **presence** — 중역 존재감이 낮은 편
4. **contact** — 접촉감이 가벼운 편
5. **brightness** — 밝기가 어두운 편
...
| 소리가 얇고 모기소리처럼 느껴져요 | PRESENCE | 얇게 느껴지지 않는 쪽으로, 짧은 한 음 유지에서 숨이 먼저 과하게 새지 않는 쪽을 찾… | PRESENCE | PASS |
...
| 숨이 많이 섞여요 | BREATHINESS | 숨 섞임이 과해지지 않는 쪽으로, 짧은 한 음 유지에서 숨이 먼저 과하게 새지 않는 쪽… | BREATHINESS | PASS |
| 소리가 너무 날카롭게 들려요 | MAINTAIN | 날카로움이 덜한 쪽으로, 작은~중간 강도에서 짧은 구절을 2~3회 부르세요. 음절 사이… | MAINTAIN | PASS |
| 거칠게 들려요 | BREATHINESS | 거친 인상이 덜한 쪽으로, 짧은 한 음 유지에서 숨이 먼저 과하게 새지 않는 쪽을 찾아… | BREATHINESS | PASS |
...
- Focus 종류: BREATHINESS, BRIGHTNESS, DYNAMICS, MAINTAIN, PRESENCE, REGISTER_CONNECTION, SAFETY, STABILITY, TIMBRE
- Protocol 종류: BREATHINESS, DYNAMICS, MAINTAIN, PHRASE_ENDURANCE, PRESENCE, REGISTER_CONNECTION, SAFETY, TIMBRE_STYLE, VIBRATO_CONTROL
- Expected shared: 46
- Over-shared: 0
- Wrong collapse: 0
