# Audio 053 — upload.webm

**Audit status:** `REVIEW`  
**Audio id:** `c5cd93ed40a3`

## 기본 정보

- 파일: `C:\VocalAgent\runtime\396250c8f971409e9b54d79d8ac9f2c7\upload.webm`
- SHA: `c5cd93ed40a39506b3acbc69cf882c57d411ef49ba3addc2c4f3e74b2ff1f805`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
| 성구 연결 | CONNECTED | — | 성구 연결이 비교적 이어짐 |
| 흉성/두성 음향 성향 | CHEST_DOMINANT | — | 흉성 성향이 두드러짐 |
...
| 배음 집중 | 0.841 | — | 0.841 |
| 음색 일관성 | UNKNOWN | — | — |
| 고음 분석 | AVAILABLE | — | 고음 구간 분석 가능 |

## 한 줄 평가

접촉감은 가벼운 편이지만, 성구 연결이 비교적 이어지는, 발성 안정성이 유지되는 편인, 중역 존재감이 낮은 편인, 밝기가 어두운 편인 발성으로 분석됐어요.

> 이 요약은 concern/target과 무관한 canonical song evidence만 사용합니다.

## 가장 중요한 특징

1. **presence** — 중역 존재감이 낮은 편
2. **contact** — 접촉감이 가벼운 편
3. **brightness** — 밝기가 어두운 편
4. **register_connection** — 성구 연결이 비교적 이어짐
5. **source_balance** — 흉성 성향이 두드러짐
...
| 고음은 나오는데 너무 힘들어요 | MAINTAIN | 고음에서 힘을 덜 쓰는 쪽으로, 편한 중음의 짧은 구절을 작은 강도로 2~3회 부르며,… | MAINTAIN | PASS |
...
| 숨이 많이 섞여요 | CONTACT | 숨 섞임이 과해지지 않는 쪽으로, 짧은 한 음 유지에서 숨이 먼저 과하게 새지 않는 쪽… | MAINTAIN | PASS |
...
- Focus 종류: BRIGHTNESS, CONTACT, DYNAMICS, EFFORT, HIGH_NOTE, MAINTAIN, PRESENCE, REGISTER_CONNECTION, SAFETY, STABILITY, TIMBRE
