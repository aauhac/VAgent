# Audio 035 — 호흡많고헤드.m4a

**Audit status:** `REVIEW`  
**Audio id:** `99023e55f0f5`

## 기본 정보

- 파일: `C:\VocalAgent\호흡많고헤드.m4a`
- SHA: `99023e55f0f5940b7cde7dff7d8abbdf56da3a9903a768a392c02968d42a0ccc`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
- Human name: `C`
- Intent: HIGH_BREATH, HEAD_LEAN
- Notes: 호흡많고헤드 — intentional high breathiness (contact_effort_controlled_v1)

| 항목 | Human | Analyzer | 결과 |
|---|---|---|---|
| effort | LOW | LOW | MATCH |
| register_connection | — | PARTIAL | NOT_LABELED |
| breathiness | HIGH | LOW | MISS |
