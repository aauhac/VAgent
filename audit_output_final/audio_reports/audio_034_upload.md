# Audio 034 — upload.webm

**Audit status:** `PASS`  
**Audio id:** `983379d1fe46`

## 기본 정보

- 파일: `C:\VocalAgent\runtime\diagnostic_sessions\e9039df1e37d44719bf930cf695ead64\tasks\sustain_i\attempt_1\upload.webm`
- SHA: `983379d1fe46018a844e384f9f0f5648d23d86003365b570f6dde8d7bf41c0ab`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
접촉감은 가벼운 편이지만, 성구 연결이 일부 구간에서만 안정적으로 이어지는, 발성 안정성이 유지되는 편인, 중역 존재감이 낮은 편인, 밝기가 어두운 편인 발성으로 분석됐어요.
