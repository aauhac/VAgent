# Audio 014 — upload.webm

**Audit status:** `PASS`  
**Audio id:** `37db691d1416`

## 기본 정보

- 파일: `C:\VocalAgent\runtime\diagnostic_sessions\46eaac51bdab4d2fa6108ee3e736b757\tasks\sustain_i\attempt_1\upload.webm`
- SHA: `37db691d14161b200b6ac892ca88b3a3eb0288d9c9df88fbfb29b9aad730d9c1`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
접촉감은 단단한 편이지만, 성구 연결이 일부 구간에서만 안정적으로 이어지는, 발성 안정성이 유지되는 편인, 중역 존재감이 낮은 편인, 밝기가 어두운 편인 발성으로 분석됐어요.
