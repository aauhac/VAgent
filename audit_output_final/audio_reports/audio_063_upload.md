# Audio 063 — upload.webm

**Audit status:** `PASS`  
**Audio id:** `d87efe3c048b`

## 기본 정보

- 파일: `C:\VocalAgent\runtime\diagnostic_sessions\f973bce50557481fad8ba55a40bcb21c\tasks\sustain_a\attempt_1\upload.webm`
- SHA: `d87efe3c048b3a701e13327d22bccf4a2d3d464e5b208b9252482cb702fb032d`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
접촉감은 단단한 편이지만, 성구 연결이 일부 구간에서만 안정적으로 이어지는, 발성 안정성이 유지되는 편인, 밝기가 어두운 편인 발성으로 분석됐어요.
