# Audio 051 — upload.webm

**Audit status:** `REVIEW`  
**Audio id:** `c3fca76b89b8`

## 기본 정보

- 파일: `C:\VocalAgent\runtime\02ca15a9e9a542cf99c19dfd6c9d1fe2\upload.webm`
- SHA: `c3fca76b89b8095917a4c8b97e723c95c1723a105e89535722eeb857aae5c5a8`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
음역이 올라가는 과정에서 성구 연결 변화가 큰이지만, 발성 안정성이 유지되는 편인, 중역 존재감이 낮은 편인, 밝기가 어두운 편인 발성으로 분석됐어요.
