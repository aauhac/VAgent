# Audio 057 — upload.webm

**Audit status:** `PASS`  
**Audio id:** `d03ad168d8d7`

## 기본 정보

- 파일: `C:\VocalAgent\runtime\diagnostic_sessions\46eaac51bdab4d2fa6108ee3e736b757\tasks\siren\attempt_1\upload.webm`
- SHA: `d03ad168d8d7335e0d42d5c4d570ef28f2d88ad292fe08088fe958f4127e1eeb`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
접촉감은 단단한 편이지만, 음역이 올라가는 과정에서 성구 연결 변화가 큰, 발성 안정성이 유지되는 편인, 중역 존재감이 낮은 편인, 밝기가 어두운 편인 발성으로 분석됐어요.
...
- Focus 종류: DYNAMICS, REGISTER_CONNECTION, SAFETY, STABILITY
- Protocol 종류: DYNAMICS, PHRASE_ENDURANCE, REGISTER_CONNECTION, SAFETY, VIBRATO_CONTROL
- Expected shared: 47
- Over-shared: 0
- Wrong collapse: 0
