# Audio 044 — upload.webm

**Audit status:** `REVIEW`  
**Audio id:** `b4b7ce279c98`

## 기본 정보

- 파일: `C:\VocalAgent\runtime\c33e338ba1a04e7aa158fcc35215f5c0\upload.webm`
- SHA: `b4b7ce279c987d50ed83eeb57137b7345fe9b052dda6094abe2b2b6f5394727b`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
성구 연결이 일부 구간에서만 안정적으로 이어지는이지만, 중역 존재감이 낮은 편인, 밝기가 어두운 편인, 숨 섞임이 적은 편인 발성으로 분석됐어요.
