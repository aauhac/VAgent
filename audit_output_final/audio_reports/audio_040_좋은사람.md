...
**Audit status:** `PASS`  
**Audio id:** `a7c957603751`

## 기본 정보

- 파일: `C:\VocalAgent\좋은사람.m4a`
- SHA: `a7c957603751d4fddebdf858da37f0fd6a1e7463c14818aea221b56b0f7af181`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
접촉감은 단단한 편이지만, 음역이 올라가는 과정에서 성구 연결 변화가 큰, 발성 안정성이 유지되는 편인, 중역 존재감이 낮은 편인, 숨 섞임이 적은 편인 발성으로 분석됐어요.
...
| 소리가 답답하게 들려요 | REGISTER_CONNECTION | 답답·어두운 인상이 덜한 쪽으로, 편한 중음에서 짧은 모음을 1~2초 유지하세요. 음량… | REGISTER_CONNECTION | PASS |
