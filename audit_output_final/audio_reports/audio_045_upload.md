# Audio 045 — upload.webm

**Audit status:** `PASS`  
**Audio id:** `b960707ab2f6`

## 기본 정보

- 파일: `C:\VocalAgent\runtime\diagnostic_sessions\c84304fcb6b843d2a1e6eb5087134291\tasks\sustain_a\attempt_1\upload.webm`
- SHA: `b960707ab2f6bbf6aee62f29c21011654ba410a0b310f452c11dd605cba2fe60`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
성구 연결이 일부 구간에서만 안정적으로 이어지는이지만, 발성 안정성이 유지되는 편인, 중역 존재감이 낮은 편인, 밝기가 어두운 편인, 숨 섞임이 적은 편인 발성으로 분석됐어요.
