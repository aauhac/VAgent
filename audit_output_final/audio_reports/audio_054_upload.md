# Audio 054 — upload.webm

**Audit status:** `REVIEW`  
**Audio id:** `c8d4b24b6f55`

## 기본 정보

- 파일: `C:\VocalAgent\runtime\7e467a88f8c845aa9b8587afd4fc90ee\upload.webm`
- SHA: `c8d4b24b6f556a80d26c28ee7113aa8805f40a516742bd8a686ed36ec35a4e86`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
음역이 올라가는 과정에서 성구 연결 변화가 큰이지만, 중역 존재감이 낮은 편인, 밝기가 어두운 편인, 숨 섞임이 적은 편인 발성으로 분석됐어요.
