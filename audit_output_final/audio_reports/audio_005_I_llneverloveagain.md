# Audio 005 — I'llneverloveagain.m4a

**Audit status:** `REVIEW`  
**Audio id:** `0f26db696e8e`

## 기본 정보

- 파일: `C:\VocalAgent\I'llneverloveagain.m4a`
- SHA: `0f26db696e8e0cb98243f8064176b11bfaeeea2eaf690ea5b4223f4e85967e4d`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
접촉감은 단단한 편이지만, 성구 연결이 일부 구간에서만 안정적으로 이어지는, 발성 안정성이 유지되는 편인, 중역 존재감이 분명한 편인, 밝기가 밝은 편인, 숨 섞임이 적은 편인 발성으로 분석됐어요.
...
3. **presence** — 중역 존재감이 높은 편
4. **brightness** — 밝기가 밝은 편
...
| 소리가 너무 날카롭게 들려요 | BRIGHTNESS | 날카로움이 덜한 쪽으로, 작은~중간 강도에서 짧은 구절을 2~3회 부르세요. 음절 사이… | TIMBRE_STYLE | PASS |
...
- Focus 종류: BRIGHTNESS, CONTACT, DYNAMICS, MAINTAIN, REGISTER_CONNECTION, SAFETY, STABILITY, TIMBRE
- Protocol 종류: DYNAMICS, MAINTAIN, PHRASE_ENDURANCE, REGISTER_CONNECTION, SAFETY, TIMBRE_STYLE, VIBRATO_CONTROL
- Expected shared: 46
- Over-shared: 0
- Wrong collapse: 0
