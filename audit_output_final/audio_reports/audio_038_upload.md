# Audio 038 — upload.webm

**Audit status:** `PASS`  
**Audio id:** `a69d81db3e48`

## 기본 정보

- 파일: `C:\VocalAgent\runtime\f189a3aec64944648c138fb3af97ff74\upload.webm`
- SHA: `a69d81db3e488bab8eca8b86c932e6e1da0fd20023887c760ecf679ce0b0c511`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
접촉감은 단단한 편이지만, 음역이 올라가는 과정에서 성구 연결 변화가 큰, 발성 안정성이 유지되는 편인, 중역 존재감이 낮은 편인, 밝기가 어두운 편인, 숨 섞임이 적은 편인 발성으로 분석됐어요.
