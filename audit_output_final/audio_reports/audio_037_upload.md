# Audio 037 — upload.webm

**Audit status:** `REVIEW`  
**Audio id:** `a29f829eedd0`

## 기본 정보

- 파일: `C:\VocalAgent\runtime\2321ae4482414bd4ad33796695d1f1ee\upload.webm`
- SHA: `a29f829eedd08ad5d7a33f7d88e4d5f840a362c7ea957039123c3633b653cf0f`
- 길이: None
- Sample Rate: None
- Analysis status: OK
- Source: fresh
...
성구 연결이 일부 구간에서만 안정적으로 이어지는이지만, 발성 안정성이 유지되는 편인, 밝기가 어두운 편인 발성으로 분석됐어요.
...
- Focus 종류: BRIGHTNESS, DYNAMICS, MAINTAIN, REGISTER_CONNECTION, SAFETY, STABILITY, TIMBRE
- Protocol 종류: DYNAMICS, MAINTAIN, PHRASE_ENDURANCE, REGISTER_CONNECTION, SAFETY, STABILITY, TIMBRE_STYLE, VIBRATO_CONTROL
- Expected shared: 46
- Over-shared: 0
- Wrong collapse: 0
...
| RECOMMEND_FOR_ME | BRIGHTNESS | — | TIMBRE_STYLE |
